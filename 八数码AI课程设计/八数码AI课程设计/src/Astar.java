...
public class Astar extends JFrame{
    ...
    public Astar() {
        ...
        //jMenuFileExit.addActionListener(new Astar_jMenuFileExit_ActionAdapter(this));
        jMenuHelp.setText("帮助主题");
        ...
        jButton1.setBounds(new Rectangle(28, 27, 81, 26));
        jButton1.setText("默认终态");
        jButton2.setBounds(new Rectangle(28, 58, 81, 25));
        jButton2.setText("手动布局");
        jPanel2.setBorder(BorderFactory.createEtchedBorder());
        jPanel2.setBounds(new Rectangle(18, 123, 99, 147));
        ...
        jCheckBox3.setBounds(new Rectangle(10, 118, 81, 23));
        ...
        jButton6.setEnabled(false);
     	...
     	jTextArea1.setEnabled(false);
          ...
          Tips = "八数码V1.0  基本功能：\n"
                +"1.随机生成:生成新布局，可以避免无解状态\n"
                +"2.手动布局：导入一个起始终点状态的布局\n"
                +"3.返回起始状态：返回初始的布局状态\n"
                +"4.自动求解：滑块自动演示求解过程\n"
                +"5.提供了人性化的拼图供用户选择\n";
                               ...
                               for(int j=0;j<3;j++)
    					        {
    					          ...
    					          jButtonGroup_start[i][j].setIcon(im);    					           					          
    					   	    ...
    					   	    if(window_flag)
								{
									JOptionPane.showMessageDialog(null,"哈哈哈，我很聪明吧！");	
									window_flag =false;
									window_step = 0;
								}
        ...
        jButton6.setBounds(new Rectangle(610, 22, 92, 32));
        jButton6.setText("恢复初始");
        
        jButton4.setBounds(new Rectangle(22, 26, 83, 26));
        jButton4.setText("数字1");
        jButton5.setBounds(new Rectangle(22, 65, 84, 25));
        jButton5.setText("数字2");
        jButton11.setBounds(new Rectangle(22, 105, 83, 26));
        jButton11.setText("拼图1");
        jButton12.setBounds(new Rectangle(22, 145, 83, 26));
        jButton12.setText("拼图2");
        jButton13.setBounds(new Rectangle(22, 185, 83, 26));
        jButton13.setText("拼图3");
        
        
        
        
        jButton7.setBounds(new Rectangle(610, 65, 92, 32));
        ...
        jLabel2.setText("执行步数：");
        jLabel2.setBounds(new Rectangle(369, 33, 69, 26));
        jLabel3.setText("已扩展结点：");
        jLabel3.setBounds(new Rectangle(369, 63, 78, 24));
        jLabel4.setText("未扩展结点：");
        jLabel4.setBounds(new Rectangle(369, 88, 80, 26));
        jLabel5.setText("执行时间：");
        jLabel5.setBounds(new Rectangle(370, 8, 66, 21));
        jScrollPane1.setBounds(new Rectangle(6, 5, 325, 114));
        jTextField5.setBounds(new Rectangle(454, 8, 116, 22));
        jTextField10.setBounds(new Rectangle(454, 39, 116, 21));
        jTextField11.setBounds(new Rectangle(454, 65, 116, 22));
        jTextField12.setBounds(new Rectangle(454, 92, 116, 21));
        jRadioButton3.setText("启发式1");
        jRadioButton3.setBounds(new Rectangle(602, 23, 103, 23));
        jRadioButton4.setText("启发式2");
        jRadioButton4.setBounds(new Rectangle(602, 74, 103, 23));
        jButton8.setBounds(new Rectangle(728, 21, 82, 32));
        jButton8.setText("开始搜索");
        jButton10.setBounds(new Rectangle(728, 65, 83, 32));
...
private  class  moveListener implements ActionListener
{
    public void actionPerformed(ActionEvent event)
    {
    	...
    	if(event.getSource()==jButton2)
    	{
    		...
    		JOptionPane.showMessageDialog(null,"请输入初始状态和结束状态！（0表示空格）");
    	}
    	...
    	if(event.getSource()==jButton9)
    	{
    		...
    		{
    			JOptionPane.showMessageDialog(null,"输入不正确或没有填满，请检查！！");
    			return;
    		}
    		else if(start_string.length()!=9||end_string.length()!=9)
    		{
    			JOptionPane.showMessageDialog(null,"输入有错，请检查！！");
    			return;
    		}
    	    ...
    	    {
    	    	JOptionPane.showConfirmDialog(null,"输入字符非法，请重新输入！");
    	    }
...
public void continue_1()
{
	String space = " ";
    	...
    	current_result+=1;
	System.out.println("=================");
	System.out.println("第"+dos_step+"步");
	dos_step++;
...
public void judge_success()
{
	...
	for(int i=0;i<3;i++)
            ...
            if(flag==9)
            {
            	JOptionPane.showMessageDialog(null,"祝贺你！到达目标");
            }
	}
...
public boolean Solve()
{
	...
	{
		JOptionPane.showMessageDialog(null,"该起始状态无法到达目标状态");
		jButton8.setEnabled(true);
		return false;
	}
	...
	jButton8.setEnabled(false);
     	...
     	JOptionPane.showMessageDialog(null,"恭喜！搜索路径成功！");
     	jButton6.setEnabled(true);
     	jButton7.setEnabled(true);


     	jTextField5.setText(" "+ (end1-start1)+ " 毫秒");
     	jTextField10.setText("一共 "+ (step-1)+ " 步");
     	jTextField11.setText(" "+en.close.size()+" 个结点");
     	jTextField12.setText(" "+en.open.size()+" 个结点");
	return true;
	
}
 
  //======================================================================
 //             判断起始和目标两个节点的逆序数，判断是否有解
 //======================================================================    
